...
class RegisterController extends GetxController {
  ...
  void register(BuildContext context)async{
    ...
    if (isValidForm(email, name, lastname, phone, password, confirmPassword, plan, precio)) {
  ...
  bool isValidForm(
    ...
    if (plan != plan) {
      Get.snackbar('Formulario no valido', 'debe ingresar plan');
      return false;
    }

    if (precio != precio) {
      Get.snackbar('Formulario no valido', 'debe ingresar precio');
      return false;
    }
