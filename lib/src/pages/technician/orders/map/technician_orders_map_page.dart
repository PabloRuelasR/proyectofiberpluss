...
import 'package:proyectofiberpluss/src/pages/technician/orders/map/technician_orders_map_controller.dart';

class TechnicianOrdersMapPage extends StatelessWidget {

  TechnicianOrdersMapController con = Get.put(TechnicianOrdersMapController());

  @override
  Widget build(BuildContext context) {
    return GetBuilder<TechnicianOrdersMapController> (
  ...
  Widget _buttonAccept(BuildContext context) {
    return Container(
      ...
      child: ElevatedButton(
        onPressed: con.isClose == true ? () => con.updateToTechnician() : null,
        child: Text(
          'ENTREGAR PEDIDO',
          style: TextStyle(
              color: Colors.black
