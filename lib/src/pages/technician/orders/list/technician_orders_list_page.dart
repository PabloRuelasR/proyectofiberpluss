...
import 'package:proyectofiberpluss/src/pages/technician/orders/list/technician_orders_list_controller.dart';
...
class TechnicianOrdersListPage extends StatelessWidget {

  TechnicianOrdersListController con = Get.put(TechnicianOrdersListController());
