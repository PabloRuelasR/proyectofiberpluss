...
import 'package:proyectofiberpluss/src/pages/client/orders/detail/client_orders_detail_controller.dart';
  ...
  Widget _dataTechnician() {
    return Container(
      ...
      child: ListTile(
        ...
        subtitle: Text('${con.order.technician?.name ?? 'No Asignado'} ${con.order.technician?.lastname ?? ''} - ${con.order.technician?.phone ?? '###'}'),
