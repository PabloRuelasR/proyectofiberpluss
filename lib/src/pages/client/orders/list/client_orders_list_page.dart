...
import 'package:proyectofiberpluss/src/pages/client/orders/list/client_orders_list_controller.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Container(
                      ...
                      margin: EdgeInsets.only(top: 5),
                      alignment: Alignment.centerLeft,
                      child: Text('Technician: ${order.technician?.name ?? 'No asignado'} ${order.technician?.lastname ?? ''}'),
                    ),
                    Container(
                      width: double.infinity,
                      margin: EdgeInsets.only(top: 5),
