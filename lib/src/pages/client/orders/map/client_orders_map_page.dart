...
import 'package:proyectofiberpluss/src/pages/client/orders/map/client_orders_map_controller.dart';
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          SizedBox(width: 15),
          Text(
            '${con.order.technician?.name ?? ''} ${con.order.technician?.lastname ?? ''}',
            style: TextStyle(
                color: Colors.white,
                fontSize: 16,
  ...
  Widget _imageClient() {
    return Container(
      ...
      child: ClipRRect(
        ...
        child: FadeInImage(
          image: con.order.technician!.image != null
              ? NetworkImage(con.order.technician!.image!)
