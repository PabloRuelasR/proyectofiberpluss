...
class OrdersProvider extends GetConnect {
  ...
  Future<List<Order>> findByTechnicianAndStatus(String idTechnician, String status) async {
    Response response = await get(
        '$url/findByTechnicianAndStatus/$idTechnician/$status',
        headers: {
          'Content-Type': 'application/json',
          'Authorization': userSession.sessionToken ?? ''
        }
  ...
  Future<ResponseApi> updateToTechnician(Order order) async {
    Response response = await put(
        '$url/updateToTechnician',
        order.toJson(),
        headers: {
          'Content-Type': 'application/json',
          'Authorization': userSession.sessionToken ?? ''
